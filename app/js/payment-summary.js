...
export function renderPaymentSummary() {
    ...
    cartSummaryHtml += `
         <div class="cart-product__details flex">
                <div class="left-side">
                  ...
                  <span class="product-total">&dollar;${formatCurrency(
                    totalPerProduct
                  )}</span>
                </div>
                <div class="right-side js-remove-cart-item" data-product-name="${
  ...
  document.querySelectorAll(`.js-remove-cart-item`).forEach((removeButton) => {
    removeButton.addEventListener("click", () => {
      ...
      document
        ...
        .classList.remove("product-added");
      document
        .querySelector(`.js-update-quantity-${productId}`)
        .classList.remove("change-quantity");
    });
  });
  ...
  function renderEmptyCart() {
    ...
    emptyCartHtml += ` <div class="cart-product">
